...
Подход основывается на наблюдении о том, что большинство повторов после неудачной операции являются холостыми. Сервер, который отказывает
операции в выполнении, уже перегружен и клиенты, которые постоянно повторют операции только делают этим хуже. Более разумно дать возможность
серверу разобраться с текущими запросами и попробовать повторить операции через некоторое время. Период ожидания также можно выбирать
не линейно, а в зависимости от времени последнего ожидания. Таким образом, мы даем возможность новым запросом обслужиться быстрее, а старым
не забивать очереди на сервере, если вероятность успешного выполнения мала.
